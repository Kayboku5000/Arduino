...
// pins for motor 1
#define RPWM_1 4 // define pin 3 for RPWM pin (output)
#define R_EN_1 15 // define pin 2 for R_EN pin (input)
#define R_IS_1 16 // define pin 5 for R_IS pin (output)

#define LPWM_1 5 // define pin 6 for LPWM pin (output)
#define L_EN_1 17 // define pin 7 for L_EN pin (input)
#define L_IS_1 18 // define pin 8 for L_IS pin (output)
// motor 1 pins end here

// pins for motor 2
#define RPWM_2 6 // define pin 9 for RPWM pin (output)
#define R_EN_2 19 // define pin 10 for R_EN pin (input)
#define R_IS_2 20 // define pin 12 for R_IS pin (output)

#define LPWM_2 7 // define pin 11 for LPWM pin (output)
#define L_EN_2 21 // define pin 7 for L_EN pin (input)
#define L_IS_2 22 // define pin 8 for L_IS pin (output)
...
void loop() {
   // BTS7960 Motor Control Code by Robojax.com 20190622 
    motor1.rotate(70,CW);// run motor 1 with 100% speed in CW direction
    delay(500);//run for 5 seconds
    motor1.stop();// stop the motor 1
    delay(300);// stop for 3 seconds
    motor1.rotate(70,CCW);// run motor 1 at 100% speed in CCW direction
    delay(500);// run for 5 seconds
    motor1.stop();// stop the motor 1
    delay(300);  // stop for 3 seconds

    motor2.rotate(70,CW);// run motor 2 with 100% speed in CW direction
    delay(500);//run for 5 seconds
    motor2.stop();// stop the motor 2
    delay(300);// stop for 3 seconds
    motor2.rotate(70,CCW);// run motor 2 at 100% speed in CCW direction
    delay(500);// run for 5 seconds
    motor2.stop();// stop the motor 2
    delay(300);  // stop for 3 seconds
